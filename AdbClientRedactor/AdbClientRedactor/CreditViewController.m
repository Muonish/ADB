...
- (void)insertNewObject:(id)sender {
    self.isView = NO;
    [self performSegueWithIdentifier:@"showCreditDetail" sender:self];
    self.isView = YES;
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"showCreditDetail"]) {
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@ %@%@ (debet: %@ credit: %@)",
                                 object.user.lastName, object.user.passport.seria,
                                 object.user.passport.number,
                                 object.debet, object.credit];
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSFetchedResultsController *aFetchedResultsController = [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest managedObjectContext:self.managedObjectContext sectionNameKeyPath:nil cacheName:@"Credit"];
